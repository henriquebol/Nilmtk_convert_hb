    ...
    def call_predict(self, classifiers, timezone):
        ...
        if self.site_only != True:
            ...
            for metric in self.metrics:
                ...
                # with open('/home/hb/teste_api', 'a') as the_file:
                #     the_file.write(computed_metric + '\n')
        ...
        if self.display_predictions:
            if self.site_only != True:
                for i in gt_overall.columns:
                    ...
                    plt.plot(gt_overall[i],label='Verdade')
                    for clf in pred_overall:
                        # print (clf)
                        # print (pred_overall[clf][i])
                        # with open('/home/hb/teste_api', 'a') as the_file:
                        #     the_file.write(pred_overall[clf][i] + '\n')  
